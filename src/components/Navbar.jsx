...
const Navbar = () => {
  ...
  const {activeMenue,setActiveMenue, handleClick, isClicked, setScreenSize, screenSize,serIsClicked} = useStateContext();
  ...
  const handleActiveMenue = () => setActiveMenue(!activeMenue);

  return (
    <div className="flex justify-between p-2 md:ml-6 md:mr-6 relative">
      <NavButton title="Menue" customFunc = {() => setActiveMenue((prevActiveMenue)=> !prevActiveMenue)} color = "blue" icon = {<AiOutlineMenu/>}/>
